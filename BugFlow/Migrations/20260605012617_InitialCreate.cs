        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cvss = table.Column<decimal>(type: "decimal(3,1)", precision: 3, scale: 1, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vulnerabilities_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vulnerabilities_Users_CreatedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vulnerabilities_CreatedBy",
                table: "Vulnerabilities",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_Vulnerabilities_ProjectId",
                table: "Vulnerabilities",
                column: "ProjectId");
        }
